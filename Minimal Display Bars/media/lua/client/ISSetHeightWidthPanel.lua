...
function ISSetHeightWidthPanel:create()
    ...
    self.factionBtn = ISButton:new(10, y, btnWid, btnHgt, getText("UI_userpanel_factionpanel"), self, ISSetHeightWidthPanel.onOptionMouseDown);
    ...
    self.ticketsBtn = ISButton:new(10, y, btnWid, btnHgt, getText("UI_userpanel_tickets"), self, ISSetHeightWidthPanel.onOptionMouseDown);
    ...
    self.cancel = ISButton:new((self:getWidth() / 2) + 5, self:getHeight() - padBottom - btnHgt, btnWid, btnHgt, getText("UI_btn_close"), self, ISSetHeightWidthPanel.onOptionMouseDown);
...
function ISSetHeightWidthPanel:new(x, y, width, height, player)
    local o = {};
